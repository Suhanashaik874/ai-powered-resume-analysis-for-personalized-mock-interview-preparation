...
import { Upload, FileText, Loader2, CheckCircle, AlertCircle, X, Brain, Tag, Trash2, Wrench } from "lucide-react";
...
function SkillsList({ skills, onUpdate }: { skills: Skill[]; onUpdate?: (s: Skill[]) => void }) {
  return (
    <div className="glass-card rounded-xl p-6">
      ...
      {skills.length === 0 ? (
        <p className="text-muted-foreground text-sm">No technologies could be extracted.</p>
      ) : (
